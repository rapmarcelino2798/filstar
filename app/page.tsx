...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-1 flex-col justify-center items-center px-4 bg-[#111318] bg-[radial-gradient(ellipse_70%_70%_at_50%_35%,_var(--tw-gradient-stops))] from-[#3a3427] via-[#1a1c23] to-[#111318]">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="mt-6 mb-8 text-[#8c9bae] text-sm sm:text-base max-w-md md:max-w-xl leading-relaxed">
